...
void chess::ui::Element::SetPosition(sf::Vector2f position_percentage) noexcept
{
...
void chess::ui::Element::SetSize(sf::Vector2f size_percentage) noexcept
{
...
{
	setPosition(position_percentage_ * sf::Vector2f(window_size));
